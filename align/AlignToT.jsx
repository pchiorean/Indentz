/*
	Align to top 23.10.4
	(c) 2020-2023 Paul Chiorean <jpeg@basement.ro>

	Aligns the selected objects to the top of the 'Align To' setting.
...
app.doScript(main, ScriptLanguage.JAVASCRIPT, doc.selection, UndoModes.FAST_ENTIRE_SCRIPT, 'Align to top');
