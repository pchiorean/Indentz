/*
	Page size from selection v1.5.0
...
if (sel.length > 0 && sel[0].constructor.name != "Guide") {
	...
	var mg = page.rectangles.add({
		geometricBounds: objBounds,
		contentType: ContentType.UNASSIGNED,
		fillColor: "None", strokeColor: "None"
	});
	// Set margins to zero
	page.marginPreferences.properties = { top: 0, left: 0, bottom: 0, right: 0 }; // Page mgs
	doc.marginPreferences.properties = { top: 0, left: 0, bottom: 0, right: 0 }; // Doc mgs
	// Resize page
