...
**Export**                               |
`PrepareForExport.jsx`          |        | Hides safe area layer and moves dielines to separate spreads
...
`QRBatch.jsx`                   |    ⇧F9 | Batch processes 'QR.txt' to add codes to existing documents or to separate files
