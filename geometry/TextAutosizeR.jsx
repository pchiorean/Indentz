/*
	Fit frame to text, right v1.5.0
	© July 2020, Paul Chiorean
	Auto-sizes the text frame to the content, right aligned.
*/
...
for (var i = 0; i < sel.length; i++) {
	var obj = sel[i]; if (obj.constructor.name == "TextFrame") FitFrame2Text(obj, "right");
}
